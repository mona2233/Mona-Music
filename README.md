 # 简要说明
 代码小白，依靠codex+gpt-5.3-codex给自己开发的一个纯本地音乐播放器，主要是厌倦了一堆乱七八糟的广告和复杂的界面，利用假期空闲时间和家里多余的绿联nas做这么个小玩意儿，所有功能和说明都是ai开发编写，我一行代码不会，功能都是我自己就足够用的，后续可能也不会再更新了，有需要的可以拿去二次开发。
